...
if __name__ == '__main__':
    ...
    questions_master = ["Who founded Apple Inc.",
                        ...
                        "Where did AT&T spread to South America?",
    ...
    print("<<<------------------------------------>>> ")
    question  = input("Type in your question and hit enter")
    # question = questions_master[-5]
    ...
    for out in outputList:
        for i in out:
            print(f"Answer {ct} : {i[0]}; Supporting Sentence: {i[1]} ; Supporting Doc: {i[2]} ")
            print("\n")
            ct += 1
